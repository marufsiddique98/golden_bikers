                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        new TextFormField(
                          ...
                          keyboardType: TextInputType.text,
                          decoration: getInputDecoration(
                              hintText: "National ID Card", labelText: "NID"),
                          initialValue: widget.user.nid,
                          validator: (input) => input.trim().length < 10
                              ? "Type valid nid minimum 10 digit"
                              : null,
                          onSaved: (input) => widget.user.nid = input,
                        ),
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          ...
                          validator: (input) => input.trim().length < 6
                              ? "insert valid date of birth"
                              : null,
                          onSaved: (input) => widget.user.DateofBirth = input,
                        ),
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          keyboardType: TextInputType.text,
